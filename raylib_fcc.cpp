        ...
        BeginDrawing();
            ...
            switch(currentScreen) 
            {
                ...
                case ABOUT:
                {
                    ...
                    DrawText("Project made by: ", 300, 120, 20, MAROON);
                    DrawText("-MD Adlaon", 300, 160, 20, DARKGRAY);
                    DrawText("-Reigner Castillo", 300, 190, 20, DARKGRAY);
                    DrawText("-Bea Licop", 300, 220, 20, DARKGRAY);
                    DrawText("-Jet Galera", 300, 250, 20, DARKGRAY);
                    DrawText("-April Nacario", 300, 280, 20, DARKGRAY);
                    DrawText("-Raphael Redondo", 300, 310, 20, DARKGRAY);
